...
System.register([], function (exports_1, context_1) {
    ...
    exports_1("patchMicroTask", patchMicroTask);
    ...
    exports_1("findEventTask", findEventTask);
    function attachOriginToPatched(patched, original) {
        patched[zoneSymbol('OriginalDelegate')] = original;
    }
    exports_1("attachOriginToPatched", attachOriginToPatched);
    var zoneSymbol, _global, isWebWorker, isNode, isBrowser, isMix, EVENT_TASKS, ADD_EVENT_LISTENER, REMOVE_EVENT_LISTENER, defaultListenerMetaCreator, originalInstanceKey;
    return {
        setters: [],
        execute: function () {/**
             * @license
            ...
            // this code.
            exports_1("isNode", isNode = (!('nw' in _global) && typeof _global.process !== 'undefined' &&
                {}.toString.call(_global.process) === '[object process]'));
            exports_1("isBrowser", isBrowser = !isNode && !isWebWorker && !!(typeof window !== 'undefined' && window['HTMLElement']));
            // we are in electron of nw, so we are both browser and nodejs
            // Make sure to access `process` through `_global` so that WebPack does not accidently browserify
            // this code.
            exports_1("isMix", isMix = typeof _global.process !== 'undefined' &&
