...
System.register(["../common/utils", "./websocket"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {/**
            ...
            frameSetEventNames = ['blur', 'error', 'focus', 'load', 'resize', 'scroll'];
